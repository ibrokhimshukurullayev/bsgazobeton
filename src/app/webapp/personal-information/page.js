  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      if (formData.avatar) {
        ...
        const uploadRes = await fetch(toApiEndpoint("/upload/file"), {
          method: "POST",
          headers: {
        ...
        uploadedImageUrl = toApiUrl(uploadData.data);
      }

      const res = await fetch(toApiEndpoint("/users/profile"), {
        method: "PUT",
        headers: {
  ...
  return (
    <div className="container">
      ...
      <div className="setting__top">
        <h3 className="setting__top__title">Profil malumotlari</h3>
      </div>
